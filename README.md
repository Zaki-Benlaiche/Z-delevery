...
| `POST /api/orders/{id}/rate` · `GET /api/orders/{id}/rating` | تقييم الزبون للطلب بعد التسليم (1-5 نجوم) |
| `GET /api/admin/drivers/pending` · `POST /api/admin/drivers/{id}/verify` · `/unverify` | إدارة توثيق السائقين |
...
- [x] **المرحلة 1.5:** الإشعارات (Web + Push) + توثيق السائقين + التقييمات
- [ ] **المرحلة 2:** الكوبونات + التقارير + مدينة ثانية + لوحة أدمن (ويب)
